...
begin
  ...
  raise LoadError, "jsonapi-serializer gem is required for JSONAPI strategy."
end
  ...
  module SerializationStrategies
    class JsonapiStrategy < BaseStrategy
      def self.render_args(model, options = {}, params = {})
        ...
        json = serializer_class.new(model, include: include_param, meta: options[:meta]).serializable_hash
